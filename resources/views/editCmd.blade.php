...
<div class="col">
<h3 class="page-title">Modifier Commande</h3>
<ul class="breadcrumb">
<li class="breadcrumb-item"><a href="teachers.html">voirCommande</a></li>
...
<form action="{{ route('edit/Action',['id' => $cmd->id]) }}" method="post">
    @csrf
    @method('PUT')
<div class="col-12 col-sm-4">
<div class="form-group local-forms">
<label>Nombre de Tickets petit dejeuner<span class="login-danger">*</span></label>
<input type="text" class="form-control" name="nbre_ticket_petitdej" value="{{$cmd->nbre_ticket_petitdej}}">
...
<input class="form-control" type="text" name="nbre_ticket_repas" value="{{$cmd->nbre_ticket_repas}}">
